...
"   (LOGO ? '.twc-launch{background:#fff!important;box-shadow:0 6px 20px rgba(15,23,42,.18),0 0 0 1px rgba(15,23,42,.06)!important;} .twc-launch:hover{box-shadow:0 10px 26px rgba(15,23,42,.24),0 0 0 1px rgba(15,23,42,.06)!important;} .twc-launch .twc-ic{width:100%;height:100%;display:flex;align-items:center;justify-content:center;} .twc-launch .twc-ic img{' + (FIT === 'contain' ? 'width:90%;height:90%;object-fit:contain;border-radius:0;' : 'width:100%;height:100%;object-fit:cover;border-radius:50%;') + '} .twc-launch.open{background:' + BRAND + '!important;} .twc-launch.open .twc-x{color:#fff;font-size:24px;}' : '');\n" +
