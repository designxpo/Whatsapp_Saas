...
export async function POST(req: Request) {
  ...
  let b: { goal?: string; websiteUrl?: string; product?: string; budgetTotal?: number; days?: number; currency?: string; countries?: string[]; audienceNote?: string; businessName?: string };
