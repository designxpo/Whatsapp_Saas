...
function HeroMock() {
  return (
    <div className="relative mx-auto mt-20 max-w-2xl">
      ...
      <FloatChip anim="animate-floaty-delay" className="-right-16 top-10"><span className="h-2 w-2 rounded-full bg-[#0164ff]" /> AI replied · 0.8s</FloatChip>
      ...
      <div className="relative z-10 rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_40px_120px_-50px_rgba(24,119,242,0.5)] animate-floaty">
        <div className="rounded-xl border border-slate-100 bg-slate-50 p-4">
          <div className="flex items-center gap-3 border-b border-slate-200 pb-3">
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0164ff] text-white"><MessageSquare className="h-4 w-4" /></span>
          ...
          <div className="space-y-3 py-4">
            ...
            <div className="ml-auto max-w-[82%] rounded-2xl rounded-tr-sm bg-[#0164ff] px-3.5 py-2 text-sm text-white">
            ...
            <div className="ml-auto flex items-center gap-1 text-[10px] font-semibold text-slate-400"><Bot className="h-3 w-3" /> Auto-replied by AI <CheckCheck className="h-3 w-3 text-[#0164ff]" /></div>
          </div>
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <Container className="relative pt-16 pb-10 text-center">
          ...
          <div className="mt-6 flex justify-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-[#0164ff]/8 px-3 py-1.5 text-xs font-semibold text-[#0164ff] ring-1 ring-[#0164ff]/15">
              <span className="flex -space-x-2">
                {["A", "R", "S"].map(c => <span key={c} className="flex h-5 w-5 items-center justify-center rounded-full bg-[#0164ff] text-[9px] font-bold text-white ring-2 ring-white">{c}</span>)}
              </span>
              {SOCIAL_PROOF}
            </span>
          </div>
      ...
      <Container className="py-12">
        ...
        <div className="mt-8 text-center">
          <Link href="/pricing" className="text-sm font-bold text-[#0164ff] hover:underline">Compare all plans →</Link>
        </div>
      </Container>
