    ...
    <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/90 backdrop-blur-xl">
      <nav className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Link href={SITE.domainCta.trial} className="rounded-full border-2 border-[#0783fd] px-4 py-1.5 text-sm font-bold uppercase tracking-wide text-[#0783fd] transition-colors hover:bg-[#0783fd] hover:text-white">Sign up now</Link>
        </div>
        ...
        <div className="border-t border-slate-100 bg-white px-5 py-4 md:hidden">
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-2 flex flex-col gap-2">
              ...
              <Link href={SITE.domainCta.trial} className="rounded-full bg-[#0783fd] px-4 py-2 text-center text-sm font-bold text-white">Sign up now</Link>
            </div>
          </div>
        </div>
      )}
...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-[#0783fd] text-white">
