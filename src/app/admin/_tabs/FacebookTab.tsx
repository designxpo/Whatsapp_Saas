    ...
    <div className="max-w-3xl space-y-5">
      ...
      <section className="bg-white rounded-card border border-line p-5 space-y-3">
        ...
        <ol className="space-y-2 text-sm text-ink-700">
          ...
          <li className="flex gap-2.5"><span className="shrink-0 w-5 h-5 rounded-full bg-brand-50 text-brand-700 text-[11px] font-bold flex items-center justify-center">2</span><span>Click <b>Connect with Facebook</b> below and choose your Page — Talko sets up the connection and message routing automatically, no developer settings to touch. (Or use <b>Add Page</b> to paste a Page <b>ID</b> and <b>access token</b> manually.)</span></li>
        </ol>
