    ...
    <div className="max-w-3xl space-y-5">
      ...
      <section className="bg-white rounded-card border border-line p-5 space-y-3">
        ...
        <ol className="space-y-2 text-sm text-ink-700">
          ...
          <li className="flex gap-2.5"><span className="shrink-0 w-5 h-5 rounded-full bg-brand-50 text-brand-700 text-[11px] font-bold flex items-center justify-center">2</span><span>On your Meta app, add the <code className="font-mono text-[12px]">pages_messaging</code> permission (and <code className="font-mono text-[12px]">pages_manage_engagement</code> + <code className="font-mono text-[12px]">pages_read_engagement</code> for comment-to-DM), and subscribe the <b>messenger</b> webhook to <code className="font-mono text-[12px]">/api/webhooks/messenger</code> (fields: <i>messages</i>, <i>feed</i>) using your existing verify token.</span></li>
