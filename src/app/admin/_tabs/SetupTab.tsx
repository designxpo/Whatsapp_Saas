...
import { AlertTriangle, CircleCheck, CircleDashed, ListChecks, Loader2, RefreshCw, Stethoscope } from "lucide-react";
...
// ── Meta connection doctor (platform owner only) ──────────────────────────────
// Diagnoses why "Connect with Facebook" / channel webhooks aren't working:
// missing vs SET-BUT-EMPTY env vars, live Graph credential validation, and the
// exact callback URLs to paste into the Meta app. Tenant admins get a 403 from
// the API, so the panel simply doesn't render for them.
