...
import { type Tab, DEFAULT_TENANT_ID, inp, btnPrimary, railLoading, type ChannelRow, ChannelSelect, setChannelCache, type Conversation, ImageUpload, ConvAvatar, ImgFallback, RailCard, StatRow, RailBar } from "./_shared";
...
const AdsTab = dynamic(() => import("./_tabs/AdsTab"), { ssr: false, loading: () => <div className="p-10 text-center text-sm text-ink-400"><Loader2 className="inline w-4 h-4 animate-spin mr-2" />Loading…</div> });
