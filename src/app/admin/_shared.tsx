...
export type ChannelRow = { id: string; kind?: "whatsapp" | "instagram" | "messenger" | "webchat"; name: string; phoneId: string; wabaId: string; igUserId?: string | null; pageId?: string | null; token: string; appId: string | null; agentId: string | null; kbTag?: string | null; mode?: "full" | "manual"; active: boolean; isDefault: boolean };
